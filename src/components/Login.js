    ...
    return ( 
        <section className="login">
         <div className="min-h-screen flex items-center justify-center bg-gray-200 py-12 px-4 sm:px-6 lg:px-8">
            ...
            <div>
                <img src="https://tailwindui.com/img/logos/workflow-mark-indigo-600.svg" alt="photo" className="mx-auto h-12 w-auto" />
            ...
            <form action="#" method="POST" className="mt-8 space-y-6">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <input type="checkbox" id="rememer-me" name="remember-me" className="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded" />
                    ...
                    <a href="#" className="font-mediun text-indigo-600 hover:text-indigo-500">
